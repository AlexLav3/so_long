...
/*   Updated: 2024/12/17 00:02:21 by elavrich         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	set_frames(t_animation *animation, t_vars *vars)
{
	...
	animation->img[0] = mlx_xpm_file_to_image(vars->mlx, "player/idle_right.xpm", 
			&img_width, &img_height);
	animation->img[1] = mlx_xpm_file_to_image(vars->mlx, "player/walk_right1.xpm",
			&img_width, &img_height);
	animation->img[2] = mlx_xpm_file_to_image(vars->mlx, "player/walk_right2.xpm",
			&img_width, &img_height);
	animation->img[3] = mlx_xpm_file_to_image(vars->mlx, "player/idle_left.xpm",
			&img_width, &img_height);
	animation->img[4] = mlx_xpm_file_to_image(vars->mlx, "player/walk_left1.xpm",
			&img_width, &img_height);
	animation->img[5] = mlx_xpm_file_to_image(vars->mlx, "player/walk_left2.xpm",
			&img_width, &img_height);
}
		...
		int map_y)
{
	...
	mlx_put_image_to_window(vars->mlx, vars->win, animation->img[animation->current_frame], map_x * TILE_SIZE, map_y * TILE_SIZE);
}
